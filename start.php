...
do {
    ...
    */
    $socket->write("USER ".$config->getConf("ident")." ".$config->getConf("hostname")." ".$config->getConf("server")." :".$config->getConf("realname"));
    $socket->write("NICK ".$config->getConf("nickname"));
    $socket->write("PASS ".$config->getConf("serverpass"));
